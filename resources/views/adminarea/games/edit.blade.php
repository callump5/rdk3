...
@section('content')
        ...
        <!-- begin::LivewireTable -->
        <div class="rounded-lg text-left w-[100%] text-white p-5">             
            <div>
                <div class="flex">
                    <!-- begin::Tabs -->
                    <div class="w-3/12">
                        <div>
                            <div class="bg-zinc-900 py-4 px-5 rounded-lg">
                                <h3 class="text-lg font-medium leading-6 ">Profile</h3>
                                <p class="mt-1 text-sm text-white text-opacity-60">This information will be displayed publicly so be careful what you share.</p>
                            </div>
                        </div>
                        <div>
                            <div class="py-4 px-5 rounded-lg">
                                <h3 class="text-lg font-medium leading-6 ">Profile</h3>
                                <p class="mt-1 text-sm text-white text-opacity-60">This information will be displayed publicly so be careful what you share.</p>
                            </div>
                        </div>
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="grid grid-cols-2 gap-3 p-3">
                                    <div class="col-span-1">
                                        <label for="company-website" class="block text-sm font-medium text-white leading">Website</label>
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <span class="inline-flex items-center rounded-l-md border border-r-0 border-zinc-900 bg-zinc-900 px-3 text-sm text-gray-500">http://</span>
                                            <input type="text" name="company-website" id="company-website" class="block w-full flex-1 rounded-none bg-zinc-900 rounded-r-md border-zinc-800 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="www.example.com">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        <label for="company-website" class="block text-sm font-medium text-white leading">Website</label>
